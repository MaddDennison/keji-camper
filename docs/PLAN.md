...
- **light social** — a shared cabin logbook and tag-a-camper (fork-on-accept, so a
  trip you did together lands in everyone's journal/passport without re-typing) is
  planned in [`docs/M4-SOCIAL.md`](M4-SOCIAL.md); copy-not-co-own, consent-by-schema
